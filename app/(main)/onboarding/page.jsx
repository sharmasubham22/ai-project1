...
import { AquaTitle, GrayTitle, SectionLabel } from '@/components/reusables'
      ...
      <div className="w-full max-w-2xl">
        <div className="text-center mb-10">
          ...
          <h1 className="font-serif text-5xl leading-tight tracking-tighter mt-1">
            ...
            <br />
            <AquaTitle>using Prepzo?</AquaTitle>
          </h1>
          ...
          <div className="grid grid-cols-2 gap-4 w-full">
            {ONBOARDING_ROLES.map((r) => (
              <button
                ...
                className="text-left cursor-pointer rounded-2xl p-8 border border-white/10 bg-card hover:border-[#8CD4CB]/20 hover:-translate-y-0.5 transition-all duration-300"
              >
                <span className="w-11 h-11 rounded-xl text-[#8CD4CB] bg-[#8CD4CB]/10 border border-[#8CD4CB]/20 flex items-center justify-center text-xl mb-5">
                  {r.icon}
                </span>
        ...
        {role && (
          <div className="flex flex-col gap-6">
            <div className="flex items-center justify-between border border-white/10 rounded-2xl px-6 py-4">
              <div className="flex items-center gap-3">
                <span className="w-9 h-9 rounded-xl text-[#8CD4CB] bg-[#8CD4CB]/10 border border-[#8CD4CB]/20 flex items-center justify-center text-base shrink-0">
            ...
            {/* interviewer form */}
            {role === "INTERVIEWER" && (
              <div className="border border-white/10 rounded-2xl p-8 flex flex-col gap-6">
                {/* Title + Company */}
                    ...
                    <button
                      ...
                      className={`text-xs px-4 py-2 rounded-lg border ${
                        form.yearsExp === opt.value
                          ? "border-[#8CD4CB]/40 bg-[#8CD4CB]/10 text-[#8CD4CB]"
